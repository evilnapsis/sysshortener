...
<html lang="en">
  <head>
    ...
    <title>SysShortener - Dashboard</title>
    <!-- Icons-->
      ...
      <div class="sidebar">
        <nav class="sidebar-nav">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="./?view=items&opt=all">
                <i class="nav-icon icon-link"></i> Enlaces
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="./?view=items&opt=top">
                <i class="nav-icon icon-chart"></i> Links Populares
              </a>
            </li>
            ...
            <li class="nav-item nav-dropdown">
              ...
              <ul class="nav-dropdown-items">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="./?view=settings" target="_top">
                    <i class="nav-icon fa fa-th-list"></i> Ajustes</a>
                </li>
              </ul>
            </li>
          <?php endif; ?>
